 ...
 */
__global__ void matrix_multiply_kernel(Matrix* left_mat, Matrix* right_mat,
                                       Matrix* result);
 ...
 */
__global__ void scalar_multiply_kernel(Matrix* input, float scalar,
                                       Matrix* output);
 ...
 */
__global__ void matrix_subtract_kernel(Matrix* mat_a, Matrix* mat_b,
                                       Matrix* result);
